...
\begin{frame}
    ...
    \begin{tabular}{c|c}
        ...
        \textrm{Roman Text} & \textbackslash{}textrm\{\} \\
...
\begin{frame}[fragile]
    ...
    \begin{tabular}{l l}
        Arch: & \texttt{\# pacman -S texlive-most}\\
        Debian/Mint/Ubuntu: & \texttt{\# apt-get install texlive-full}\\
        Fedora: & \texttt{\# yum install texlive}\\
        Windows/OS X: & \texttt{Follow instructions at} \\
                      & \texttt{https://tug.org}
    \end{tabular}
\end{frame}
\end{document}
